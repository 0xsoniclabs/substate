...
func (m *MockUpdateDB) GetSubstateEncoding() SubstateEncodingSchema {
	m.ctrl.T.Helper()
...
func (mr *MockUpdateDBMockRecorder) GetSubstateEncoding() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSubstateEncoding", reflect.TypeOf((*MockUpdateDB)(nil).GetSubstateEncoding))
}
...
func (m *MockUpdateDB) SetSubstateEncoding(schema SubstateEncodingSchema) error {
	m.ctrl.T.Helper()
...
func (mr *MockUpdateDBMockRecorder) SetSubstateEncoding(schema any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetSubstateEncoding", reflect.TypeOf((*MockUpdateDB)(nil).SetSubstateEncoding), schema)
}
